...
class Graph:
    ...
    def bellmanford(self, start_vertex_data):
        ...
        return (False, distances, predecessors) # Indicate no negative cycle and return distance
...
# Running the Bellman-Ford algorithm from D to all vertices
print("\nThe Bellman-Ford Algorithm starting from vertex D:")
negative_cycle, distances, predecessors = g.bellmanford('D')
